...
<div className="my-12 text-center">
  <a 
    ...
    className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-gold to-gold-light hover:from-gold-dark hover:to-gold text-navy font-bold py-4 px-8 rounded-xl transition-all shadow-lg shadow-gold/20 hover:shadow-xl hover:-translate-y-1 hover:scale-105 duration-300"
  >
