          ...
          <div className="lg:col-span-2 hidden lg:block">
            <div className="relative">
              ...
              <div className="relative glass-card rounded-2xl p-8 bg-white/5 border border-white/10">
                {/* Avatar placeholder */}
                <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-gold to-gold-light flex items-center justify-center text-navy text-4xl font-bold font-serif">
                  DN
                </div>
